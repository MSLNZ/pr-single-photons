...
project = 'pr-single-photons'
copyright = photons.__copyright__[1:]
author = photons.__author__
...
version = photons.__version__
# The full version, including alpha/beta/rc tags.
release = photons.__version__
...
htmlhelp_basename = 'pr-single-photonsdoc'
...
latex_documents = [
    (master_doc, 'pr-single-photons.tex', 'pr-single-photons Documentation',
...
man_pages = [
    (master_doc, 'pr-single-photons', 'pr-single-photons Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pr-single-photons', 'pr-single-photons Documentation',
     author, 'pr-single-photons', 'pr-single-photons',
     'Miscellaneous'),
]
